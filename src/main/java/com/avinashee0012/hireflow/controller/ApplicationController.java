...
public class ApplicationController{
    ...
    @PostMapping("/{jobId}")
    @PreAuthorize("hasRole('CANDIDATE')") public ResponseEntity<ApplicationResponseDto> applyToJob(
    ...
    @PreAuthorize("hasRole('CANDIDATE')") public ResponseEntity<Void> withdrawApplication(
    ...
    @PreAuthorize("hasAnyRole('RECRUITER','ORGADMIN')") public ResponseEntity<ApplicationResponseDto> updateApplicationStatus(
            @PathVariable Long applicationId, @Valid @RequestBody ApplicationStatusUpdateRequestDto request){
        return ResponseEntity.status(HttpStatus.OK).body(applicationService.updateStatus(applicationId, request));
    }

    @GetMapping
    @PreAuthorize("hasAnyRole('RECRUITER','ORGADMIN','CANDIDATE','SUPPORT')") public ResponseEntity<Page<ApplicationResponseDto>> getApplications(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(applicationService.getApplications(page, sortby, direction));
    }
}
